...
class ChatApp(App):
    ...
    def __init__(self, provider, model, stream=False):
        ...
        self.status_text = f"Modelo: {model} | Tokens: 0 | Streaming: {'Activado' if stream else 'Desactivado'} | MCP: {'Desactivado'}"
    ...
    def _update_status_bar(self):
        ...
        self.status_text = f"Modelo: {self.model} | Tokens: {self.token_count} | Streaming: {'Activado' if self.stream else 'Desactivado'} | MCP: {'Activado' if self.mcp_enabled else 'Desactivado'}"
